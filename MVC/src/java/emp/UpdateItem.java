...
public class UpdateItem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        java.util.Date item_date=new SimpleDateFormat("MM/dd/yyyy").parse(itemdate);
        item.setItemDatepb(item_date);
        String date=request.getParameter("itemtype");
        item.setItemType(new ItemTypeBean().getItemType(Integer.parseInt(request.getParameter("itemtype"))));
